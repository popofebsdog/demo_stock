...
- `+2` 出現多方 K 線：錘子線、陽包陰、曙光初現、晨星、大紅K；反轉型態需先有短期跌勢背景。
- `-1` RSI 大於等於 80，視為過熱。
- `-2` 出現空方 K 線：陰包陽、烏雲罩頂、黃昏星、大綠K；反轉型態需先有短期漲勢背景。

K 線型態判斷：

- `錘子線`：短期跌勢後，實體小、下影線至少是實體 2 倍且至少占全長 35%，上影線不超過全長 25%。
- `大紅K` / `大綠K`：實體至少占全長 75%，方向分別為紅 K / 綠 K。
- `陽包陰` / `陰包陽`：短期反向趨勢後，第二根 K 的實體需完整吞噬前一根實體，且第二根實體需大於前一根。
- `曙光初現`：短期跌勢後，前一根為長黑 K，隔日開低並收在前一根實體中點之上、開盤價之下。
- `烏雲罩頂`：短期漲勢後，前一根為長紅 K，隔日開高並收在前一根實體中點之下、開盤價之上。
- `晨星` / `黃昏星`：短期反向趨勢後，第一根需為長實體，第二根為小實體，第三根反向收過第一根實體中點。
...
報表中的 `漲跌幅` 是日漲跌幅：用官方收盤價、官方漲跌價差與 TWSE 的 `漲跌(+/-)` 符號反推前一交易日收盤價，再換算百分比。

有些個股可能超過 10%，通常是官方資料本身標示為特殊狀態，例如新掛牌、恢復交易、除權息或無一般漲跌幅限制。系統不會硬把這類資料壓成 10%，避免扭曲官方行情。
